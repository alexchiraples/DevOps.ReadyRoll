-- <Migration ID="b6780039-4e59-46a4-8cfc-c42fe79b086f" TransactionHandling="Custom" />
GO

/*
	NOTE: This script contains additional logic due to the inclusion of Full Text Catalog, Stop or Index objects:
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_catalogs WHERE name = N'AW2008FullTextCatalog')
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Product_ProductID' AND object_id = OBJECT_ID(N'[Production].[Product]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Store_BusinessEntityID' AND object_id = OBJECT_ID(N'[Sales].[Store]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_PhoneNumberType_PhoneNumberTypeID' AND object_id = OBJECT_ID(N'[Person].[PhoneNumberType]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_PersonPhone_BusinessEntityID_PhoneNumber_PhoneNumberTypeID' AND object_id = OBJECT_ID(N'[Person].[PersonPhone]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Person_BusinessEntityID' AND object_id = OBJECT_ID(N'[Person].[Person]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_EmailAddress_BusinessEntityID_EmailAddressID' AND object_id = OBJECT_ID(N'[Person].[EmailAddress]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ContactType_ContactTypeID' AND object_id = OBJECT_ID(N'[Person].[ContactType]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_BusinessEntityContact_BusinessEntityID_PersonID_ContactTypeID' AND object_id = OBJECT_ID(N'[Person].[BusinessEntityContact]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_StateProvince_StateProvinceID' AND object_id = OBJECT_ID(N'[Person].[StateProvince]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_CountryRegion_CountryRegionCode' AND object_id = OBJECT_ID(N'[Person].[CountryRegion]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_BusinessEntityAddress_BusinessEntityID_AddressID_AddressTypeID' AND object_id = OBJECT_ID(N'[Person].[BusinessEntityAddress]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_AddressType_AddressTypeID' AND object_id = OBJECT_ID(N'[Person].[AddressType]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Address_AddressID' AND object_id = OBJECT_ID(N'[Person].[Address]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Vendor_BusinessEntityID' AND object_id = OBJECT_ID(N'[Purchasing].[Vendor]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Employee_BusinessEntityID' AND object_id = OBJECT_ID(N'[HumanResources].[Employee]'))
...
[AccountNumber] AS ('AW'+CONVERT([varchar](15),[CustomerID],(0)))
)
GO
PRINT N'Creating primary key [PK_Customer_CustomerID] on [Sales].[Customer]'
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Customer_CustomerID' AND object_id = OBJECT_ID(N'[Sales].[Customer]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductListPriceHistory_ProductID_StartDate' AND object_id = OBJECT_ID(N'[Production].[ProductListPriceHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductCostHistory_ProductID_StartDate' AND object_id = OBJECT_ID(N'[Production].[ProductCostHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ShipMethod_ShipMethodID' AND object_id = OBJECT_ID(N'[Purchasing].[ShipMethod]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductInventory_ProductID_LocationID' AND object_id = OBJECT_ID(N'[Production].[ProductInventory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_BillOfMaterials_BillOfMaterialsID' AND object_id = OBJECT_ID(N'[Production].[BillOfMaterials]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ShoppingCartItem_ShoppingCartItemID' AND object_id = OBJECT_ID(N'[Sales].[ShoppingCartItem]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_EmployeePayHistory_BusinessEntityID_RateChangeDate' AND object_id = OBJECT_ID(N'[HumanResources].[EmployeePayHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_JobCandidate_JobCandidateID' AND object_id = OBJECT_ID(N'[HumanResources].[JobCandidate]'))
...
JOIN sys.fulltext_catalogs ON sys.fulltext_indexes.fulltext_catalog_id = sys.fulltext_catalogs.fulltext_catalog_id 
WHERE  name = N'AW2008FullTextCatalog' AND object_id = OBJECT_ID(N'[HumanResources].[JobCandidate]', 'U'))
...
JOIN sys.columns ON fulltext_index_columns.object_id = sys.columns.object_id AND fulltext_index_columns.column_id = sys.columns.column_id 
WHERE sys.columns.object_id = OBJECT_ID(N'[HumanResources].[JobCandidate]') AND sys.columns.name = N'Resume')
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SpecialOffer_SpecialOfferID' AND object_id = OBJECT_ID(N'[Sales].[SpecialOffer]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_TransactionHistory_TransactionID' AND object_id = OBJECT_ID(N'[Production].[TransactionHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductReview_ProductReviewID' AND object_id = OBJECT_ID(N'[Production].[ProductReview]'))
...
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_indexes 
JOIN sys.fulltext_catalogs ON sys.fulltext_indexes.fulltext_catalog_id = sys.fulltext_catalogs.fulltext_catalog_id 
WHERE  name = N'AW2008FullTextCatalog' AND object_id = OBJECT_ID(N'[Production].[ProductReview]', 'U'))
...
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_index_columns 
JOIN sys.columns ON fulltext_index_columns.object_id = sys.columns.object_id AND fulltext_index_columns.column_id = sys.columns.column_id 
WHERE sys.columns.object_id = OBJECT_ID(N'[Production].[ProductReview]') AND sys.columns.name = N'Comments')
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_TransactionHistoryArchive_TransactionID' AND object_id = OBJECT_ID(N'[Production].[TransactionHistoryArchive]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductVendor_ProductID_BusinessEntityID' AND object_id = OBJECT_ID(N'[Purchasing].[ProductVendor]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_WorkOrder_WorkOrderID' AND object_id = OBJECT_ID(N'[Production].[WorkOrder]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_PurchaseOrderDetail_PurchaseOrderID_PurchaseOrderDetailID' AND object_id = OBJECT_ID(N'[Purchasing].[PurchaseOrderDetail]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_WorkOrderRouting_WorkOrderID_ProductID_OperationSequence' AND object_id = OBJECT_ID(N'[Production].[WorkOrderRouting]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_PurchaseOrderHeader_PurchaseOrderID' AND object_id = OBJECT_ID(N'[Purchasing].[PurchaseOrderHeader]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Document_DocumentNode' AND object_id = OBJECT_ID(N'[Production].[Document]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'UQ__Document__F73921F793071A63' AND object_id = OBJECT_ID(N'[Production].[Document]'))
ALTER TABLE [Production].[Document] ADD CONSTRAINT [UQ__Document__F73921F793071A63] UNIQUE NONCLUSTERED  ([rowguid])
GO
PRINT N'Adding full text indexing to tables'
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_indexes 
JOIN sys.fulltext_catalogs ON sys.fulltext_indexes.fulltext_catalog_id = sys.fulltext_catalogs.fulltext_catalog_id 
WHERE  name = N'AW2008FullTextCatalog' AND object_id = OBJECT_ID(N'[Production].[Document]', 'U'))
...
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_index_columns 
JOIN sys.columns ON fulltext_index_columns.object_id = sys.columns.object_id AND fulltext_index_columns.column_id = sys.columns.column_id 
WHERE sys.columns.object_id = OBJECT_ID(N'[Production].[Document]') AND sys.columns.name = N'DocumentSummary')
ALTER FULLTEXT INDEX ON [Production].[Document] ADD ([DocumentSummary] LANGUAGE 1033)
GO
IF NOT EXISTS (SELECT 1 FROM sys.fulltext_index_columns 
JOIN sys.columns ON fulltext_index_columns.object_id = sys.columns.object_id AND fulltext_index_columns.column_id = sys.columns.column_id 
WHERE sys.columns.object_id = OBJECT_ID(N'[Production].[Document]') AND sys.columns.name = N'Document')
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID' AND object_id = OBJECT_ID(N'[Sales].[SalesOrderDetail]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesOrderHeader_SalesOrderID' AND object_id = OBJECT_ID(N'[Sales].[SalesOrderHeader]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_EmployeeDepartmentHistory_BusinessEntityID_StartDate_DepartmentID' AND object_id = OBJECT_ID(N'[HumanResources].[EmployeeDepartmentHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesPerson_BusinessEntityID' AND object_id = OBJECT_ID(N'[Sales].[SalesPerson]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Location_LocationID' AND object_id = OBJECT_ID(N'[Production].[Location]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesPersonQuotaHistory_BusinessEntityID_QuotaDate' AND object_id = OBJECT_ID(N'[Sales].[SalesPersonQuotaHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesTerritory_TerritoryID' AND object_id = OBJECT_ID(N'[Sales].[SalesTerritory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesTaxRate_SalesTaxRateID' AND object_id = OBJECT_ID(N'[Sales].[SalesTaxRate]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Department_DepartmentID' AND object_id = OBJECT_ID(N'[HumanResources].[Department]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Shift_ShiftID' AND object_id = OBJECT_ID(N'[HumanResources].[Shift]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductModelProductDescriptionCulture_ProductModelID_ProductDescriptionID_CultureID' AND object_id = OBJECT_ID(N'[Production].[ProductModelProductDescriptionCulture]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductModel_ProductModelID' AND object_id = OBJECT_ID(N'[Production].[ProductModel]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductDescription_ProductDescriptionID' AND object_id = OBJECT_ID(N'[Production].[ProductDescription]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesTerritoryHistory_BusinessEntityID_StartDate_TerritoryID' AND object_id = OBJECT_ID(N'[Sales].[SalesTerritoryHistory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ScrapReason_ScrapReasonID' AND object_id = OBJECT_ID(N'[Production].[ScrapReason]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductCategory_ProductCategoryID' AND object_id = OBJECT_ID(N'[Production].[ProductCategory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductDocument_ProductID_DocumentNode' AND object_id = OBJECT_ID(N'[Production].[ProductDocument]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SpecialOfferProduct_SpecialOfferID_ProductID' AND object_id = OBJECT_ID(N'[Sales].[SpecialOfferProduct]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductModelIllustration_ProductModelID_IllustrationID' AND object_id = OBJECT_ID(N'[Production].[ProductModelIllustration]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductPhoto_ProductPhotoID' AND object_id = OBJECT_ID(N'[Production].[ProductPhoto]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductProductPhoto_ProductID_ProductPhotoID' AND object_id = OBJECT_ID(N'[Production].[ProductProductPhoto]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_BusinessEntity_BusinessEntityID' AND object_id = OBJECT_ID(N'[Person].[BusinessEntity]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_ProductSubcategory_ProductSubcategoryID' AND object_id = OBJECT_ID(N'[Production].[ProductSubcategory]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_UnitMeasure_UnitMeasureCode' AND object_id = OBJECT_ID(N'[Production].[UnitMeasure]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_CountryRegionCurrency_CountryRegionCode_CurrencyCode' AND object_id = OBJECT_ID(N'[Sales].[CountryRegionCurrency]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_CreditCard_CreditCardID' AND object_id = OBJECT_ID(N'[Sales].[CreditCard]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Culture_CultureID' AND object_id = OBJECT_ID(N'[Production].[Culture]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Currency_CurrencyCode' AND object_id = OBJECT_ID(N'[Sales].[Currency]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_CurrencyRate_CurrencyRateID' AND object_id = OBJECT_ID(N'[Sales].[CurrencyRate]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesOrderHeaderSalesReason_SalesOrderID_SalesReasonID' AND object_id = OBJECT_ID(N'[Sales].[SalesOrderHeaderSalesReason]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Illustration_IllustrationID' AND object_id = OBJECT_ID(N'[Production].[Illustration]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_Password_BusinessEntityID' AND object_id = OBJECT_ID(N'[Person].[Password]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_SalesReason_SalesReasonID' AND object_id = OBJECT_ID(N'[Sales].[SalesReason]'))
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'PK_PersonCreditCard_BusinessEntityID_CreditCardID' AND object_id = OBJECT_ID(N'[Sales].[PersonCreditCard]'))
...
EXEC sp_addextendedproperty N'MS_Description', N'AdventureWorks 2012 Sample OLTP Database', NULL, NULL, NULL, NULL, NULL, NULL
GO
